...
• Longitudinal Research (Basic Concepts and Considerations)

  -   Concepts and considerations of developmental research

• Longitudinal Data (Interpretation / Issues / Pitfalls & Assumptions)

  -   Considerations when working with large longitudinal datasets
  
  -   xxxxx

• Longitudinal Analysis (Methods/Procedures/Models/etc...)

  -   Learn how to apply xxxxx to large longitudinal data such as the ABCD Study

  -   Use linked open-source materials to get started more quickly


most commonly used analysis for abcd data

Learn 

• to demonstrate the use of various longitudinal models
• to discuss the connections between the methods for modeling
• to compare existing methods to deal with longitudinal xxxxxx
...
**Outline:**
Longitudinal Research (Basic Concepts and Considerations)
Longitudinal Data (Interpretation / Issues / Pitfalls & Assumption)
Longitudinal Analysis (Methods/Procedures/Models/etc...)
...
## xxx types of analysis for abcd study data xxxx
...
[Opening paragraph of discussion xxxxx.]

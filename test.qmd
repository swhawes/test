...
![LDA Structural Diagram](./figures/LDA Structure 2.png){#fig-LDAstruct  fig-alt="LDA Structure Diagram." width=600 height=400 fig-align="center"}
...
[psychometrics as a new "Part" below, or facets of psychometrics (e.g., invariance, reliability, etc...) inserted above?]

# Part III: Additional Section(s)

\label{sec:headings} \## In Progress: \[TBD\]
...
![Longitudinal Models](./figures/Mindmap1.png){#fig-LONGmod fig-alt="Longitudinal Models Diagram." width=600 height=400 fig-align="center"}

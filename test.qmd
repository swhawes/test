  ...
  plos-pdf:
    ...
    include-in-header:
      text: |
        ...
        % \doublespacing
author:
  - name: Samuel W. Hawes, PhD.
    affiliations:
      - ref: aff1
    corresponding: true
    email: shawes@fiu.edu
  - name: Andrew K. Littlefield, PhD.
    affiliations:
      - ref: aff2
  - name: Daniel A. Lopez
    affiliations:
  ...
  - name: Wesley K. Thompson
    affiliations:
      - ref: aff5
  - name: Additional Co-authors1
    affiliations:
      - ref: aff1
  - name: Additional Co-authors2
    affiliations:
      - ref: aff1
author-notes:
  group: Biostatistics Working Group membership list can be found in the Acknowledgments sections
affiliations:
  - id: aff1
    name: Center for Children and Families, Florida International University
    city: Miami
    state: FL
    country: United States
  - id: aff2
    name: Psychological Sciences, Texas Tech University
    city: Lubbock
    state: TX
    country: United States
  - id: aff3
    name: Department of Public Health, University of Rochester Medical Center
    city: Rochester
    state: NY
    country: United States
  - id: aff4
    name: Psychological Sciences, University of Missouri
    city: Columbia
    state: MO
    country: United States
  - id: aff5
    name: Population Neuroscience and Genetics Center, Laureate Institute for Brain Research
    city: Tulsa
    state: OK
    country: United States
abstract: |
